  ...
  public override func viewDidLoad() {
    ...
    layout: do {
      ...
      root: do {
        ...
        editContainerView.accessibilityIdentifier = "app.streettagged.editContainerView"
        controlContainerView.accessibilityIdentifier = "app.streettagged.controlContainerView"
